...
<?php if($error): print('<div class="panel" style="margin-right: 15px;border-radius: 0px;"><div class="panel-heading"><h3 class="panel-title"> Внимание!</h3></div><div class="panel-body yobject-marked">'.$error.'</div></div>'); else: ?>
	...
	<div class="full-box" style="    border: 4px solid #a20105;">
		<div class="poster">
			<img src="<?=$u["image"];?>">
		</div>
		<div class="infor">
			...
			<div class="buy-item" style="padding: 10px;margin-top: 10px;">
				...
				<a href="/buy/<?=$u["id"];?>" style="cursor: pointer;width: 100%;text-align: center;margin-top: 5px;font-size: 19px;text-decoration: none;background-image: linear-gradient(0deg, #d4145a, #fbb03b);height: 50px;line-height: 50px;border-radius: 3px;" class="buy-link">Купить товар</a>
			</div>
		</div>
	</div>
